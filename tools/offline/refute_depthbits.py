...
def main():
    ...
    cases = [
        ...
        ('13b span 0.05-100 comment ', 13, 0.05, 100.0),
        ('13b span 0.05-12  tight   ', 13, 0.05, 12.0),
        ('12b span 0.05-12          ', 12, 0.05, 12.0),
        ('11b span 0.05-12          ', 11, 0.05, 12.0),
        ('8b  span 0.05-12  stress  ', 8, 0.05, 12.0),
    ]
    for f in frames:
        rot, t = poses[f]
